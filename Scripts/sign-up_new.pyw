...
ASSETS_PATH = OUTPUT_PATH / P(r"Assets/sign-up new")
...
entry_bg_7 = canvas.create_image(359.5,
    523.5360431671143,image=house_img)
house = Entry(bd=0, bg="#FFFFFF", fg="#000716", highlightthickness=0)
house.place(x=271.0, y=500.9, width=177.0, height=43.092594146728516)
...
nname.place(x=271.0, y=500.5, width=177, height=43.092594146728516)
