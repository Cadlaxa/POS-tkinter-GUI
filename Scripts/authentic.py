...
# Products
def castoria():
    script_path = "Scripts/product_frames/authentic_castoria.py"
...
canvas.create_text(490.0, 36.0, anchor="nw",
                   text="Authentic", fill="#FFFFFF", font=("Montserrat SemiBold", 32 * -1))
icon(window)
